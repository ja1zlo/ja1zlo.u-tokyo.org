...
const ForNewcomer = () => (
  <article className={styles.article}>
    ...
    <section className={styles.shadowed_box}>
      <h3>☆入部をご希望の方へ☆</h3>
      新歓情報・初回部会についての連絡のため、<br />
      <a href="https://forms.gle/UGgrHVMPQYwStK5d6" target="_blank"><b>こちら</b></a>
      のフォームより連絡先の登録にご協力お願いします。<br />
    </section>

    <p>
      <a href="https://ja1zlo.u-tokyo.org/lp/AboutContest.pdf" target="_blank">
    ...
    <section className={styles.content}>
      <div>
        ...
        <section>
          ...
          いや、現状としてはそのとおり！！
          でも携帯やインターネットは他人が用意したインフラに乗っかっているだけで、実は自分から何もアクションを起こしていないのでは？ <br />
        ...
        <section>
          ...
          私たちのサークルはこの「コンテスト」を活動の中心のひとつとしています。<br />
    ...
    <section className={styles.content}>
      ...
      <section>
        ...
        <ul className={ styles.list_sche_wrap }>
          <li className={ styles.list_sche }>
            部会<br />
            <small>毎週火曜日18:30〜。イベントの準備をしたり、通常交信をしたり、ゆるりと活動しています。</small>
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className={ styles.list_sche_wrap }>
          ...
          <li className={ styles.list_sche }>
            ALL JAコンテスト<br />
            <small>年間4つあるJARL主催コンテストの1つ。泊りがけで24時間、得点を競います。</small>
          </li>
          <li className={ styles.list_sche }>
            関東社団大学間ミーティング<br />
            <small>関東のほかの大学のアマチュア無線部と交流できるイベントです。</small>
          </li>
          <li className={ styles.list_sche }>
            ALL JA1コンテスト<br />
            <small>東大無線部主催のコンテスト。規約改訂や結果の集計も自分たちでやります。</small>
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className={ styles.list_sche_wrap }>
          <li className={ styles.list_sche }>
            6m AND DOWNコンテスト<br />
            <small>JARL主催コンテストの1つ。高い周波数を用いるためテクニックが必要です。</small>
          </li>
          <li className={ styles.list_sche }>
            フィールドデーコンテスト<br />
            <small>JARL主催コンテストの1つ。野外でテントとアンテナを張り参加します。</small>
          </li>
          <li className={ styles.list_sche }>
            ハムフェア<br />
            <small>東京ビッグサイトで行われるアマチュア無線家の祭典。東大無線部も出展し、ALL JA1コンテストの表彰や部誌の展示などを行います。</small>
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className={ styles.list_sche_wrap }>
          <li className={ styles.list_sche }>
            全市全郡コンテスト<br />
            <small>JARL主催コンテストの1つ。とくに規模が大きく、1年の集大成のつもりで望みます。</small>
          </li>
          <li className={ styles.list_sche }>
            CQ WW DX CONTEST<br />
            <small>世界を舞台にしたコンテスト。地球の裏側と交信できた時の喜びは計り知れないものです。</small>
          </li>
          <li className={ styles.list_sche }>
            駒場祭<br />
            <small>部員の電子工作の成果や、モールス練習体験などを展示します。</small>
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className={ styles.list_sche_wrap }>
          <li className={ styles.list_sche }>
            移動運用（登山など）<br />
            <small>ハンディ機（いわゆる「トランシーバー」的な）を持って高いところを目指します。平地との電波の飛びの違いに驚きます。</small>
          </li>
          <li className={ styles.list_sche }>
            次の新歓の準備<br />
          </li>
  ...
  return (
    <div>
      <div className={styles.btn_open} onClick={()=>setOpen(a=>!a)}>
        <img src={props.src} alt={props.comment} className={styles.gallery_image} style={{ width:"100%", height:"100%" }} />
      </div>
